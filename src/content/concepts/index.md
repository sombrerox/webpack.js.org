...
In the example above, the `html-webpack-plugin` generates an HTML file for your application by injecting automatically all of your generated bundles.
...
Learn more about the [mode configuration here](/concepts/mode) and which optimizations take place on each value.
